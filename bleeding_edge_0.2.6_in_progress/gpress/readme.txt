...
= 0.2.6 - XX/XXXX/2011 =
* ADDED _gpress TABLE for Storing Locations
* REPLACED CORE gpress_map Functions
* ADDED CORE gpress_marker Functions
...
1. Better Namespacing PHP Classes and Simple Function Names
2. Re-Write Shortcodes using new Marker and Map Functions
3. Provide Advanced Filtering Options to All Shortcodes
4. Allow for Integration with 3rd Party Location Providers
5. Allow for Production of Static Snapshot Maps
6. Allow for Polygon Generation
7. Allow for Trail Generation
...
1. Introduce "Components" such as Gallery Add-On
