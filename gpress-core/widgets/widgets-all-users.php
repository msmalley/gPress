...
if(GPRESS_BP){
    add_action( 'widgets_init', 'gpress_all_users_load_widgets' );
}

function gpress_all_users_load_widgets() {
	register_widget( 'GPRESS_ALL_USERS_WIDGET' );
}

class GPRESS_ALL_USERS_WIDGET extends WP_Widget {

	function GPRESS_ALL_USERS_WIDGET() {
		$widget_ops = array( 'classname' => 'gpress-all-users', 'description' => __('Show all geo-tagged users', 'gpress') );
		$this->WP_Widget( 'gpress-all-users-widget', __('All Geo-Tagged Users', 'gpress'), $widget_ops, $control_ops );
	}
	...
	function widget( $args, $instance ) {
		...
		$gpress_this_widget_title = __('All Geo-Tagged Users', 'gpress');
		...
		echo $before_widget;
			...
			echo do_shortcode('[gpress place_id="all" post_type="users" map_type="'.$type.'" map_zoom="'.$zoom.'" map_height="'.$height.'"]');
	...
	function form( $instance ) {
        ...
        jQuery(document).ready(function(){
            var widget_all_users_state; if(!widget_all_users_state){
                widget_all_users_state = 'closed';
