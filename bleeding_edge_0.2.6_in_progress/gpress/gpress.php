...
define( 'GPRESS_VERSION', 0.26 );
define( 'GPRESS_DB_VERSION', 1 );
define( 'GPRESS_DB_TABLE', $wpdb->prefix.'gpress');
...
function load_after_buddypress() {
	...
	if(get_bloginfo('version') < GPRESS_MIN_VERSION) {
		...
		include( GPRESS_DIR . '/gpress-core/gpress-sql.php' );
		...
		include( GPRESS_DIR . '/gpress-core/gpress-meta.php' );
...
/* REGISTER DATABASE */
include(GPRESS_DIR.'/gpress-core/gpress-schema.php');
register_activation_hook(GPRESS_DIR.'/gpress.php','gpress_install_db');
//-> USE THIS TO FORCE THE DATABASE TO BE UPDATED ->
gpress_install_db(true);
